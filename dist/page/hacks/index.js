...
(() => {
  ...
  // src/page/hacks/const.js
  var photo = document.querySelector("[data-api-photo]");
  var name = document.querySelector("[data-api-name]");
  var job = document.querySelector("[data-api-job]");
  var linkedin = document.querySelector("[data-api-linkedin]");
  var body = document.querySelector("[data-color]");
  var quote = document.querySelector("[data-api-markdown]");
  var currentIndex = document.querySelector("[data-api-current]");
  var totalIndex = document.querySelector("[data-api-total]");
  var templateTag = document.querySelector("[data-tag]");
  var tagList = document.querySelector(".hack_dash_content_tag_list");
  var swiperComponent = document.querySelector("[swiper-component]");
  var swiperEl = swiperComponent.querySelector(".swiper");
  var colors = ["bleu", "violet", "jaune", "vert", "rouge"];
  var templateSlide = document.querySelector(".swiper-slide");
  var clone = templateSlide.cloneNode(true);

  // src/page/hacks/fetch.js
  var API_URL = "https://x8ki-letl-twmt.n7.xano.io/api:DdhYCmh_/temoignages_freelance";
  ...
  // src/page/hacks/index.js
  var currentColor = "";
  totalIndex.textContent = "320";
  var mySwiper;
  function initSwiper() {
  ...
  var displayData = function(data) {
    const { items } = data;
    const templateSlide2 = document.querySelector(".swiper-slide");
    console.log(templateSlide2);
    items.forEach((item) => {
      var clone2 = templateSlide2.cloneNode(true);
      currentIndex.textContent = item.id;
      name.textContent = item.nom;
      quote.textContent = item.Temoignage;
      photo.setAttribute("src", item.img_url);
      mySwiper.appendSlide(clone2);
    });
    templateSlide2.style.display = "none";
  };
